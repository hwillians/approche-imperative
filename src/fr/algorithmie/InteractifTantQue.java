...
public class InteractifTantQue {
	...
	public static void main(String[] args) {
		...
		// Si le nombre est compris entre 1 et 10, le programme affiche ce nombre et se
		// termine.

		// Instruction pour poser une question à l’utilisateur : Nous allons utiliser la
